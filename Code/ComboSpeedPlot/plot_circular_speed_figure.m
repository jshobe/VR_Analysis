...
%% Position labels
labelR = outerMaxR + 6;
positionLabelFontSize = cfg.axisFontSize;
positionLabelColor = [0.2 0.2 0.2];

positionDegs = [0 90 180 270];
positionTexts = {'0/360°', '90°', '180', '270°'};

for i = 1:numel(positionDegs)
    thLabel = positionDegs(i) / 360 * 2*pi;
    [xLabel, yLabel] = pol2cart(thLabel, labelR);

    text(xLabel, yLabel, positionTexts{i}, ...
        'HorizontalAlignment', 'center', ...
        'VerticalAlignment', 'middle', ...
